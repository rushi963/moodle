...
$string['alphanumerical'] = 'Can only contain alphanumeric characters such as A-Za-z0-9, hyphen (-) or period (.)';
...
$string['invalidusername'] = 'The username can only contain alphanumeric lowercase characters such as a-z0-9, underscore (_), hyphen (-), period (.) or at symbol (@)';
