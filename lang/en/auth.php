...
$string['errorminpasswordnonalphanum'] = 'Passwords must have at least {$a} non-alphanumeric character(s) such as *, -, # etc.';
...
$string['informminpasswordnonalphanum'] = 'at least {$a} non-alphanumeric character(s) such as *, -, # etc.';
